...
This document describes how to install the prerequisites to run cuMatch.
...
- CMake 3.15 ([link](https://cmake.org/files/v3.15))
```
$ wget https://cmake.org/files/v3.15/cmake-3.15.0-Linux-x86_64.tar.gz
$ tar xvfz cmake-3.15.0-Linux-x86_64.tar.gz
$ export CMAKE_HOME=/your/path/cmake-3.15.0-Linux-x86_64
$ export PATH=$CMAKE_HOME/bin:$PATH
```

- Boost 1.82.0 ([link](https://archives.boost.io/release/1.82.0/source))
```
